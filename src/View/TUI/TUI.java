...
public class TUI {
	...
	public void loginMenu() {
		...
		System.out.println("Flag!! TUI80: " + sid);
...
//			System.out.println("member");
	...
	public void MemberMenu() {
		while (true) {
			...
			System.out.println("11. 상품조회하기	21. 주문 전체조회");
			...
			case 11:
				...
				break;
			case 12:
				Map<String,Object> param12memb = new HashMap();
				param12memb.put("sid", sid);
				
				Map<String, Object> result12memb = controller.execute("/order", 1, param12memb);
